...
public class Drive extends SubsystemBase {
  ...
  static final double ODOMETRY_FREQUENCY =
      new CANBus(TunerConstantsHelper.DrivetrainConstants.CANBusName).isNetworkFD() ? 250.0 : 100.0;
  ...
  public Drive(
    ...
    this.vision = vision;
    this.gyroIO = gyroIO;
    modules[0] = new Module(flModuleIO, 0, TunerConstantsHelper.FrontLeft);
    modules[1] = new Module(frModuleIO, 1, TunerConstantsHelper.FrontRight);
    modules[2] = new Module(blModuleIO, 2, TunerConstantsHelper.BackLeft);
    modules[3] = new Module(brModuleIO, 3, TunerConstantsHelper.BackRight);
  ...
  public double getMaxLinearSpeedMetersPerSec() {
    return TunerConstantsHelper.kSpeedAt12Volts.in(MetersPerSecond);
  }
