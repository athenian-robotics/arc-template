...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    driveTalon = new TalonFX(constants.DriveMotorId, TunerConstantsHelper.kCANBus);
    turnTalon = new TalonFX(constants.SteerMotorId, TunerConstantsHelper.kCANBus);
    cancoder = new CANcoder(constants.EncoderId, TunerConstantsHelper.kCANBus);
